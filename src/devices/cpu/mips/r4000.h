...
protected:
	...
	enum inst_list : u32
	{
		OPCODE_SPECIAL  = (0x00u << 26),
		OPCODE_REGIMM   = (0x01u << 26),
		OPCODE_J 		= (0x02u << 26),
		OPCODE_JAL      = (0x03u << 26),
		OPCODE_BEQ      = (0x04u << 26),
		OPCODE_BNE	    = (0x05u << 26),
		OPCODE_BLEZ     = (0x06u << 26),
		OPCODE_BGTZ     = (0x07u << 26),
		OPCODE_ADDI     = (0x08u << 26),
		OPCODE_ADDIU    = (0x09u << 26),
		OPCODE_SLTI     = (0x0au << 26),
		OPCODE_SLTIU    = (0x0bu << 26),
		OPCODE_ANDI     = (0x0cu << 26),
		OPCODE_ORI      = (0x0du << 26),
		OPCODE_XORI     = (0x0eu << 26),
		OPCODE_LUI      = (0x0fu << 26),
		OPCODE_COP0     = (0x10u << 26),
		OPCODE_COP1     = (0x11u << 26),
		OPCODE_COP2     = (0x12u << 26),
		OPCODE_COP1X    = (0x13u << 26),
		OPCODE_BEQL     = (0x14u << 26),
		OPCODE_BNEL     = (0x15u << 26),
		OPCODE_BLEZL    = (0x16u << 26),
		OPCODE_BGTZL    = (0x17u << 26),
		OPCODE_DADDI    = (0x18u << 26),
		OPCODE_DADDIU   = (0x19u << 26),
		OPCODE_LDL      = (0x1au << 26),
		OPCODE_LDR      = (0x1bu << 26),
		OPCODE_LB       = (0x20u << 26),
		OPCODE_LH       = (0x21u << 26),
		...
		OPCODE_SDR      = (0x2du << 26),
		OPCODE_SWR      = (0x2eu << 26),
		OPCODE_CACHE    = (0x2fu << 26),
		OPCODE_LL       = (0x30u << 26),
		OPCODE_LWC1     = (0x31u << 26),
		OPCODE_LWC2     = (0x32u << 26),
		// NOP 0x33
		OPCODE_LLD      = (0x34u << 26),
		OPCODE_LDC1     = (0x35u << 26),
		OPCODE_LDC2     = (0x36u << 26),
		OPCODE_LD       = (0x37u << 26),
		OPCODE_SC       = (0x38u << 26),
		OPCODE_SWC1     = (0x39u << 26),
		OPCODE_SWC2     = (0x3au << 26),
		// NOP 0x3b
		OPCODE_SCD      = (0x3cu << 26),
		OPCODE_SDC1     = (0x3du << 26),
		OPCODE_SDC2     = (0x3eu << 26),
		OPCODE_SD       = (0x3fu << 26),
	};

	enum cache_inst_list : u32
	{
		SPCODE_SLL        = (0x00u | OPCODE_SPECIAL),
		//                = (0x01u | OPCODE_SPECIAL),
		SPCODE_SRL 	      = (0x02u | OPCODE_SPECIAL),
		SPCODE_SRA        = (0x03u | OPCODE_SPECIAL),
		SPCODE_SLLV       = (0x04u | OPCODE_SPECIAL),
		//		          = (0x05u | OPCODE_SPECIAL),
		SPCODE_SRLV       = (0x06u | OPCODE_SPECIAL),
		SPCODE_SRAV       = (0x07u | OPCODE_SPECIAL),
		SPCODE_JR         = (0x08u | OPCODE_SPECIAL),
		SPCODE_JALR       = (0x09u | OPCODE_SPECIAL),
		//SLTI            = (0x0au | OPCODE_SPECIAL),
		//SLTIU           = (0x0bu | OPCODE_SPECIAL),
		SPCODE_SYSCALL    = (0x0cu | OPCODE_SPECIAL),
		SPCODE_BREAK      = (0x0du | OPCODE_SPECIAL),
		//                = (0x0eu | OPCODE_SPECIAL),
		SPCODE_SYNC       = (0x0fu | OPCODE_SPECIAL),
		SPCODE_MFHI       = (0x10u | OPCODE_SPECIAL),
		SPCODE_MTHI       = (0x11u | OPCODE_SPECIAL),
		SPCODE_MFLO       = (0x12u | OPCODE_SPECIAL),
		SPCODE_MTLO       = (0x13u | OPCODE_SPECIAL),
		SPCODE_DSLLV      = (0x14u | OPCODE_SPECIAL),
		//                = (0x15u | OPCODE_SPECIAL),
		SPCODE_DSRLV      = (0x16u | OPCODE_SPECIAL),
		SPCODE_DSRAV      = (0x17u | OPCODE_SPECIAL),
		SPCODE_MULT       = (0x18u | OPCODE_SPECIAL),
		SPCODE_MULTU      = (0x19u | OPCODE_SPECIAL),
		SPCODE_DIV        = (0x1au | OPCODE_SPECIAL),
		SPCODE_DIVU       = (0x1bu | OPCODE_SPECIAL),
		SPCODE_DMULT      = (0x1cu | OPCODE_SPECIAL),
		SPCODE_DMULTU     = (0x1du | OPCODE_SPECIAL),
		SPCODE_DDIV       = (0x1eu | OPCODE_SPECIAL),
		SPCODE_DDIVU      = (0x1fu | OPCODE_SPECIAL),
		SPCODE_ADD        = (0x20u | OPCODE_SPECIAL),
		SPCODE_ADDU       = (0x21u | OPCODE_SPECIAL),
		SPCODE_SUB        = (0x22u | OPCODE_SPECIAL),
		SPCODE_SUBU       = (0x23u | OPCODE_SPECIAL),
		SPCODE_AND        = (0x24u | OPCODE_SPECIAL),
		SPCODE_OR         = (0x25u | OPCODE_SPECIAL),
		SPCODE_XOR        = (0x26u | OPCODE_SPECIAL),
		SPCODE_NOR        = (0x27u | OPCODE_SPECIAL),
		//                = (0x28u | OPCODE_SPECIAL),
		//                = (0x29u | OPCODE_SPECIAL),
		SPCODE_SLT        = (0x2au | OPCODE_SPECIAL),
		SPCODE_SLTU       = (0x2bu | OPCODE_SPECIAL),
		SPCODE_DADD       = (0x2cu | OPCODE_SPECIAL),
		SPCODE_DADDU      = (0x2du | OPCODE_SPECIAL),
		SPCODE_DSUB       = (0x2eu | OPCODE_SPECIAL),
		SPCODE_DSUBU      = (0x2fu | OPCODE_SPECIAL),
		SPCODE_TGE        = (0x30u | OPCODE_SPECIAL),
		SPCODE_TGEU       = (0x31u | OPCODE_SPECIAL),
		SPCODE_TLT        = (0x32u | OPCODE_SPECIAL),
		SPCODE_TLTU       = (0x33u | OPCODE_SPECIAL),
		SPCODE_TEQ        = (0x34u | OPCODE_SPECIAL),
		//                = (0x35u | OPCODE_SPECIAL),
		SPCODE_TNE        = (0x36u | OPCODE_SPECIAL),
		//                = (0x37u | OPCODE_SPECIAL),
		SPCODE_DSLL       = (0x38u | OPCODE_SPECIAL),
		//                = (0x39u | OPCODE_SPECIAL),
		SPCODE_DSRL       = (0x3au | OPCODE_SPECIAL),
		SPCODE_DSRA	      = (0x3bu | OPCODE_SPECIAL),
		SPCODE_DSLL32     = (0x3cu | OPCODE_SPECIAL),
		//                = (0x3du | OPCODE_SPECIAL),
		SPCODE_DSRL32     = (0x3eu | OPCODE_SPECIAL),
		SPCODE_DSRA32     = (0x3fu | OPCODE_SPECIAL),
	};
